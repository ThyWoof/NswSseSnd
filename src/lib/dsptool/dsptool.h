...
void encode(int16_t* src, uint8_t* dst, ADPCM_INFO* cxt, uint32_t samples);
void decode(uint8_t* src, int16_t* dst, ADPCM_INFO* cxt, uint32_t samples);
void getLoopContext(uint8_t* src, ADPCM_INFO* cxt, uint32_t samples);
